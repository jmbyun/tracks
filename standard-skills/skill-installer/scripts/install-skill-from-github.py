#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into $AGENT_HOME_PATH/skills."""
...
def _agent_home_path() -> str:
    return os.environ.get("AGENT_HOME_PATH", os.getcwd())


def _tmp_root() -> str:
    base = os.path.join(tempfile.gettempdir(), "tracks")
...
def _default_dest() -> str:
    return os.path.join(_agent_home_path(), "skills")
